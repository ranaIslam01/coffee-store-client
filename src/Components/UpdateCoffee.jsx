    ...
    return (
        <div className='pt-18'>
            <div className='px-[15%] py-12.5' style={{ backgroundImage: `url(${coffeeBg})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
                ...
                {/* Update Coffee Form */}
                <div className='lg:px-28 px-10 py-17.5 bg-[#F4F3F0] mt-8 rounded-2xl'>
                    ...
                    <form className='flex flex-col gap-6'>
                        <div className='grid lg:grid-cols-2 gap-6'>
                            <div className='flex flex-col gap-4'>
                                ...
                                <input className='py-3 px-3 bg-white rounded-lg w-full outline-none' type="text" defaultValue={name} placeholder='Enter Coffee Name' />
                            </div>
                            <div className='flex flex-col gap-4'>
                                <label className='font-semibold text-xl text-[#1B1A1ACC]'>Quantity</label>
                                <input className='py-3 px-3 bg-white rounded-lg w-full outline-none' type="text" defaultValue={quantity} placeholder='Enter Coffee Quantity' />
                            </div>
                        </div>
                        ...
                        <div className='grid lg:grid-cols-2 gap-6'>
                            <div className='flex flex-col gap-4'>
                                ...
                                <input className='py-3 px-3 bg-white rounded-lg w-full outline-none' type="text" defaultValue={supplier} placeholder='Enter Coffee Supplier' />
                            </div>
                            <div className='flex flex-col gap-4'>
                                <label className='font-semibold text-xl text-[#1B1A1ACC]'>Taste</label>
                                <input className='py-3 px-3 bg-white rounded-lg w-full outline-none' type="text" defaultValue={taste} placeholder='Enter Coffee Taste' />
                            </div>
                        </div>
                        ...
                        <div className='grid lg:grid-cols-2 gap-6'>
                            <div className='flex flex-col gap-4'>
                                ...
                                <input className='py-3 px-3 bg-white rounded-lg w-full outline-none' type="text" defaultValue={price} placeholder='Enter Coffee Price' />
                            </div>
                            <div className='flex flex-col gap-4'>
                                <label className='font-semibold text-xl text-[#1B1A1ACC]'>Details</label>
                                <input className='py-3 px-3 bg-white rounded-lg w-full outline-none' type="text" defaultValue={details} placeholder='Enter Coffee Details' />
                            </div>
                        </div>

                        <div className='flex flex-col gap-4'>
                            <label className='font-semibold text-xl text-[#1B1A1ACC]'>Photo URL</label>
                            <input className='py-3 px-3 bg-white rounded-lg w-full outline-none' type="text" defaultValue={photo} placeholder='Enter Photo URL' />
                        </div>
